...
eval_device = '0'
eval_doc_path = './MFRNet_Baseline_3_Scale_train_pth/eval.txt'
eval_num_thread = 10

# An example to build "eval_roots".
eval_roots = dict()
datasets = ['amphibious', 'insect', 'land', 'sea', 'sky', 'all']

for dataset in datasets:
    roots = {'gt': './CoCOD8K/test/groundtruth/'+ dataset + '/',
            'pred': './MFRNet_res_test/MFRNet_Baseline_3_Scale_train_pth/'+ dataset + '/'}
